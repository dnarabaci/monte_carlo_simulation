...
```
cd existing_repo
git remote add origin https://gitup.uni-potsdam.de/arabaci2/sbi-montecarlo.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitup.uni-potsdam.de/arabaci2/sbi-montecarlo/-/settings/integrations)
